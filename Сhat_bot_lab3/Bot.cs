...
namespace Сhat_bot_lab3
{
        public class Bot : AbstractChatBot
        {
            ...
            {
            new Regex(@"(?:привет|хай|Привет)"),
            new Regex(@"(?:Скажи мне время\??|сколько сейчас времени\??|время\??)"),
            new Regex(@"(?:какое сегодня число\??|Скажи дату\??|число\??)"),
            new Regex(@"как дела\??"),
            ...
            new Regex(@"погода|какая сегодня погода"),
            new Regex(@"чем заняться дома??"),
            };
            ...
            {
                return "Привет, " + userName + " давно не виделись :)";
            }
        }
            ...
            static string HowAreYou(string question)
            {
                ...
                {
                    return "Также как вчера, и позавчера, и вообще всегда :)";
                }
            }

            static string Thank(string question)
            {
            ...
            static string MulPls(string question)
            {
                ...
                {
                    return "извините, не понимаю. повторите, пожалуйста, ввод.";
                }
            }
            ...
            static string PlusPls(string question)
            {
                ...
                {
                    return "Извините, не понимаю. Повторите ввод.";
                }
            }
            ...
            static string Hous(string question)
            {
                Random rnd = new Random();
                int value = rnd.Next();
                if (value % 2 == 0)
                    return "Дома всегда можно заняться чем-то интересным\r\n1) Заняться своей фигурой, но важно не переусердвствовать.\r\n2) Научиться чему-то новому\r\n3) Можно почитать книгу или посмотреть фильм. :)";
                else
                {
                return "Вы можете пригласить друзей в гости. В компании всегда веселее и вы точно решите чем заняться.";
                }
            }
            ...
            public override string Answ(string userQuestion)
            {
                ...
                return "Прошу прощения вы иностранец? Если нет то задайте правильный вопрос.";
            }
